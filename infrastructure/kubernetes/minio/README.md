...
kubectl run -it --rm mc-test --image=pgsty/mc:RELEASE.2026-09-16T00-00-00Z --restart=Never -n vrsky-storage -- /bin/sh
...
kubectl run -it --rm mc-test --image=pgsty/mc:RELEASE.2026-09-16T00-00-00Z --restart=Never -n vrsky-storage -- \
